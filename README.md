...
- Animated Indian flag, Ashoka Chakra, particles and tricolour ribbons
- Premium stage lighting and illuminated edge rings
...
- Uploaded F-16 GLB fly-past behind the finalized scene.
- Dense cloud-sprite saffron, white and green emissions with expansion, turbulence and fade.
- Subtle white and sky-blue ambient clouds above the backdrop.
- Landing-page preview replaced with the actual greeting card and four mobile AR steps.
- All finalized foreground object positions remain unchanged.
